(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('prop-types'), require('react'), require('aphrodite/no-important'), require('react-dom'), require('react-transition-group'), require('aphrodite'), require('react-scrolllock')) :
  typeof define === 'function' && define.amd ? define(['prop-types', 'react', 'aphrodite/no-important', 'react-dom', 'react-transition-group', 'aphrodite', 'react-scrolllock'], factory) :
  (global.ImgsViewer = factory(global.PropTypes,global.React,global.aphrodite,global.ReactDOM,global.ReactTransitionGroup,global.aphrodite,global.ScrollLock));
}(this, (function (PropTypes,React,noImportant,reactDom,reactTransitionGroup,aphrodite,ScrollLock) { 'use strict';
  ...
  var Portal = function (_Component) {
    ...
    createClass(Portal, [{
      ...
      value: function componentDidUpdate() {
        ...
        // )
        // NEW (FOR REACT 18)
        this.root = client_1(this.portalElement);
        this.root.render(React__default.createElement(
          'div',
          null,
